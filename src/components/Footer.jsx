...
const Footer = () => {
  ...
  <div className="bg-gray-100 py-8 border-t-2">
    <div className="max-w-screen-lg px-4 sm:px-6 text-gray-800 sm:grid md:grid-cols-4 sm:grid-cols-2 mx-auto">
      <div className="p-5">
        <h3 className="font-bold text-xl text-indigo-600">M365 Pros.</h3>
      ...
      <div className="p-5">
        ...
        <a className="my-3 block" href="/#">XXX XXXX, Floor 4 San Kathmandu, Thimi
