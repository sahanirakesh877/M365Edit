  ...
  return (
    <>
      <footer className="">
        <div className="bg-[#193357] py-16 border-t-2">
          <div className="max-w-screen-lg px-4 sm:px-6 text-gray-400 sm:grid md:grid-cols-4 sm:grid-cols-2 mx-auto">
            ...
            <div className="p-5 ">
              ...
              <a className="my-3 block poppins-regular" href="/#">
                Support{" "}
                <span className="text-gray-400 text-xs p-1 poppins-regular">
                  New
                </span>
              </a>
            </div>
            ...
            <div className="p-5">
              ...
              <a className="my-1 block poppins-regular" href="/#">
              ...
              <a className="my-1 block poppins-regular" href="https://m365pros.com">
                www.m365pros.com
        ...
        <div className="bg-[#0C2D57] pt-2">
          <div
            className="flex pb-2 px-3 m-auto pt-5 border-t text-gray-300 text-sm flex-col
max-w-screen-lg items-center"
          >
            <div className="md:flex-auto md:flex-row-reverse mt-2 flex-row flex">
              <a href="/#" className="w-6 mx-1">
                <svg
                  className="fill-current cursor-pointer text-gray-300 hover:text-indigo-600"
                  width="100%"
                  height="100%"
                  viewBox="0 0 24 24"
                  version="1.1"
            ...
            -2.103,2.102l0,0.97l-0.969,0l0,1.617l0.969,0l0,4.689l1.941,0l0,-4.689Z"
              ...
              <a href="https://www.linkedin.com/company/m365pros/" className="w-6 mx-1">
                <svg
                  className="fill-current cursor-pointer text-gray-300 hover:text-indigo-600"
                  width="100%"
                  height="100%"
            ...
            <div className="flex items-center my-4 justify-between lg:space-x-12  space-x-2">
            <div className=" poppins-regular">
              © Copyright 2024. All Rights Reserved.
            </div>
            <div className="  poppins-regular">
              Designed By : <strong><a href="https://technavata.com">Navata Tech</a></strong>
            </div>
            </div>
          </div>
        </div>
