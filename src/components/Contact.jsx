...
const Contact = () => {
  return (
    <>
      <div className="container my-28 mx-auto px-2 md:px-4">
  <section className="mb-24">
    <div className="flex justify-center">
      ...
      <h2 className="px-2 text-4xl font-semibold text-blue-700 text-nowrap ">Contact us</h2>
      <div className="border-t-2 border-red-700  w-[40px]"></div>

      </div>
    
        <p className="text-base">We are always available to support you.Feel free to call us and get details</p>
      </div>
    </div>
    <div className="flex flex-wrap">
      <form className="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
        ...
        <div className="mb-3 w-full">
          ...
          <textarea className="px-2 py-2 border rounded-[5px] w-full outline-none" name id defaultValue={""} />
        </div>
        <button type="button" className="mb-6 inline-block w-full rounded bg-blue-900 px-6 py-2.5 font-medium uppercase leading-normal text-white hover:shadow-md hover:bg-blue-800">
          Send
        </button>
      </form>
